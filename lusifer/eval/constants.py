...
CROSS_LINGUAL_INSTRUCTION = {
    ...
    'BelebeleRetrieval': 'Given a question, retrieve passages that answer the question.',
    'STS17': 'Retrieve semantically similar text.',
    # 'mFollowIRCrossLingualInstructionRetrieval': 'Given a question, retrieve passages that answer the question.',
    # 'XPQARetrieval': 'Given a question, retrieve passages that answer the question.',
    'STS22.v2': 'Retrieve semantically similar text.',
    # 'CrossLingualSemanticDiscriminationWMT21': 'Retrieve semantically similar text.',
    # 'CrossLingualSemanticDiscriminationWMT19': 'Retrieve semantically similar text.',
}
