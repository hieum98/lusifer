        ...
        if model_name_or_path == 'izhx/udever-bloom-7b1':
            ...
            if torch.cuda.is_available():
                if model_name_or_path in ['nvidia/NV-Embed-v2', 'princeton-nlp/sup-simcse-roberta-large', 
                                          ...
                                          'BAAI/bge-large-en-v1.5', 'intfloat/e5-large', 'intfloat/multilingual-e5-large',
                                          'Alibaba-NLP/gte-multilingual-base', 'sentence-transformers/paraphrase-multilingual-mpnet-base-v2']:
